...
class StateCards extends Component {
  ...
  totalDistrict = async () => {
    ...
    const confirmedCard = {
      name: 'Confirmed',
      logo:
        'https://res.cloudinary.com/dfxl8sk2x/image/upload/v1687501676/check-mark_1_i3k0bx.png',
    ...
    const activeCard = {
      name: 'Active',
      logo:
        'https://res.cloudinary.com/dfxl8sk2x/image/upload/v1687501711/protection_1_q45yhs.png',
    ...
    const recoveredCard = {
      name: 'Recovered',
      logo:
        'https://res.cloudinary.com/dfxl8sk2x/image/upload/v1687501737/recovered_1_bvzqal.png',
    ...
    const deceasedCard = {
      name: 'Deceased',
      logo:
        'https://res.cloudinary.com/dfxl8sk2x/image/upload/v1687501774/breathing_1_bcazld.png',
